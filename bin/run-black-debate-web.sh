...
npm run start -- --full --screen 1 --restart_time 01:00:00 --root "https://blackfacts.com/kiosk?delay=2000&playlist=hpjNGTYvpxw"
...
# !!@ Dead link
# https://www.youtube.com/watch?v=EBFh8Elfjj4
# How W.E.B. DuBois Set the Terms of Debate About Race in 20th-Century America (2003)
