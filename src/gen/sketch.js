...
let a_config = {
  ...
  settings: [
    ...
    { label: 'skin-tone-guest-3', import_path: 'settings/skin-tone-guest-3.json' },
    {
      label: 'skin-tone-guest-face_mesh-align-none',
      import_path: 'settings/skin-tone-guest-face_mesh-align-none.json',
    },
    { label: 'skin-tone-guest-maze_spin-0', import_path: 'settings/skin-tone-guest-maze_spin-0.json' },
    { label: 'skin-tone-guest', import_path: 'settings/skin-tone-guest.json' },
    { label: 'skin-tone-main-qr-1', import_path: 'settings/skin-tone-main-qr-1.json' },
    { label: 'skin-tone-main-qr-maze_spin-0', import_path: 'settings/skin-tone-main-qr-maze_spin-0.json' },
