...
import { ui_div_empty } from '../core-ui/ui_tools.js?v=409';
import { effectMeta_find } from '../core/effectMeta.js?v=409';
import { ui_patch_update } from '../core-ui/ui_patch_bar.js?v=409';
import { patch_remove_ipatch, patch_update_effIndex } from '../a/patch_inst.js?v=409';
import { patch_create_other } from '../core-ui/ui_patch_create.js?v=409';
