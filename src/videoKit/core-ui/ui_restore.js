...
import { a_effectMetas } from '../let/a_effectMetas.js?v=406';
import { a_settingMetas } from '../let/a_settingMetas.js?v=406';
import { effectMeta_init } from '../core/effectMeta.js?v=406';
import { ui_capture_init } from '../core-ui/ui_capture.js?v=406';
import { ui_canvas_init } from '../core-ui/ui_canvas.js?v=406';
import { store_name_restore, store_url_parse, store_save_ent } from '../core/store_url_parse.js?v=406';
import { canvas_size_default } from '../core-ui/ui_canvas.js?v=406';
import { reset_video_clear_locals } from '../core/reset_video_clear_locals.js?v=406';
import { ui_present_window } from '../core-ui/a_ui_create.js?v=406';
import { store_set, store_get, store_remove } from '../core-ui/ui_prop.js?v=406';

// import { ui_render_size_init } from '../core-ui/ui_render.js?v=406';
//
// let effects = [
