...
export let a_effectMetas =  [
    ...
    { label: 'face_band', import_path: 'videoKit/effects/eff_face_band.js' },
    { label: 'face_mesh', import_path: 'videoKit/effects/eff_face_mesh.js' },
    { label: 'fft_graph', import_path: 'videoKit/effects/eff_fft_graph.js' },
    { label: 'fft_polar', import_path: 'videoKit/effects/eff_fft_polar.js' },
